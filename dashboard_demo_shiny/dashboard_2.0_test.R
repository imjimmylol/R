...
# read source ?p?G?O?ð?????reopen with encoding utf-8
source('C:/Users/user/Desktop/OAO/test_gloable_nlp_2.0.R', local = TRUE)
source('C:/Users/user/Desktop/OAO/test_gloable_sales_2.0.R', local = TRUE)
...
body <- dashboardBody(
  tabItems(
    ...
    tabItem(tabName = 'id_2', 
            ...
            fluidRow(
              box(
                dateRangeInput("date_range", "請選則日期:",
